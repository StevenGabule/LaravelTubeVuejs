            ...
            <channel-uploads inline-template>
                ...
                <div class="col-md-8">
                    <div class="card p-3 d-flex justify-content-center align-items-center" v-if="!selected">
                        <svg onclick="document.getElementById('video-files').click()" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                        ...
                        <input type="file" ref="videos" id="video-files" class="d-none" accept="video/*" @change="upload">
